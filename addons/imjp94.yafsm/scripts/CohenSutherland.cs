...
namespace GodotRollbackNetcode.StateMachine
{
    public class CohenSutherland
	{
		...
		public int ComputeCode(float x, float y, float xMin, float yMin, float xMax, float yMax)
		{
		...
		public bool LineIntersectRectangle(Vector2 from, Vector2 to, Rect2 rect)
		{
